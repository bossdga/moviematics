...
import ie.fleetmatics.moviematics.adapter.TvShowAdapter;
...
public class TvShowFragment extends BaseFragment {
     ...
     */
    public static TvShowFragment newInstance(String sortBy, int pageNumber) {
    ...
    private void addObserver(CompositeSubscription subscription) {
        subscription.add(apiContext.getTvShows(mSortBy, mPageNumber)
                ...
                .subscribe(new Subscriber<List<TvShow>>() {
                    ...
                    public void onNext(List<TvShow> tvShows) {
                        mAdapter = new TvShowAdapter(tvShows, getActivity());
